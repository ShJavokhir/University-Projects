...
public class Display extends JFrame {
  ...
  public Display() {
    ...
    dijkstra = readGraph("./group_project1_ds/cityxy.txt", "./group_project1_ds/citypairs.txt");
    ...
    txtCityxytxt.setText("./group_project1_ds/cityxy.txt");
    ...
    txtCitypairstxt.setText("./group_project1_ds/citypairs.txt");
